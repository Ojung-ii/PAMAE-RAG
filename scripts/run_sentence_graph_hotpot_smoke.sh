...
MAX_QUERIES=100
OUT_ROOT="outputs/sentence_graph_smoke/hotpotqa"
...
REF_CONFIG="configs/content_graph/hotpotqa_content_graph_refine_cell.yaml"
SENT_CONFIG="configs/sentence_graph/hotpot_sentence_smoke.yaml"
