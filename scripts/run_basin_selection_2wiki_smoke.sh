...
OUT_ROOT="${OUT_ROOT:-outputs/basin_selection_smoke/2wikimultihopqa}"
...
run_variant "current_content" "configs/content_graph/2wikimultihopqa_content_graph_refine_cell.yaml"
run_variant "basin_preserving_selection" "configs/content_graph/2wikimultihopqa_content_graph_basin_preserving.yaml"
run_variant "basin_preserving_selection_plus_basin_renderer" "configs/content_graph/2wikimultihopqa_content_graph_basin_preserving_basin_renderer.yaml"
