...
OUT_ROOT="${OUT_ROOT:-outputs/path_realizability_smoke/hotpotqa}"
...
run_variant "current_content_current_renderer" "configs/content_graph/hotpotqa_content_graph_refine_cell.yaml"
run_variant "current_content_gold_path_oracle_renderer" "configs/content_graph/hotpotqa_content_graph_gold_path_oracle.yaml"
run_variant "current_content_path_neighborhood_renderer" "configs/content_graph/hotpotqa_content_graph_path_neighborhood.yaml"
run_variant "basin_preserving_selection_current_renderer" "configs/content_graph/hotpotqa_content_graph_basin_preserving.yaml"
run_variant "basin_preserving_selection_gold_path_oracle_renderer" "configs/content_graph/hotpotqa_content_graph_basin_preserving_gold_path_oracle.yaml"
run_variant "basin_preserving_selection_path_neighborhood_renderer" "configs/content_graph/hotpotqa_content_graph_basin_preserving_path_neighborhood.yaml"
