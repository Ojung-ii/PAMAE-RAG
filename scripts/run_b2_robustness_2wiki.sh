...
MAX_QUERIES=1000
OUT_ROOT="outputs/b2_robustness/2wikimultihopqa"
...
RAW_QA="data/processed/2wikimultihopqa.json"
RAW_CORPUS="data/processed/2wikimultihopqa_corpus.json"
INPUT="${OUT_ROOT}/inputs/examples_${MAX_QUERIES}.jsonl"
...
if [[ -n "${FALLBACK_REASON:-}" ]]; then
  printf '%s\n' "${FALLBACK_REASON}" > "${OUT_ROOT}/FALLBACK_REASON.txt"
fi
